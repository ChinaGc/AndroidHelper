package com.gc.android_helper.view.picker.lib;
...
import com.gc.android_helper.view.picker.adapter.WheelAdapter;
...
public class WheelView extends View {
    ...
    private void measureTextWidthHeight() {
        ...
        itemHeight = lineSpacingMultiplier * maxTextHeight*1.2f;
    }
     ...
     * @param
     */
    public final void setTextSizePx(int size) {
        if (size > 0 ) {
            paintOuterText.setTextSize(textSize);
            paintCenterText.setTextSize(textSize);
        }
     ...
     * @param spSize
     */
    public final void setTextSizeSp(int spSize) {
        if (spSize > 0 ) {
            spSize = sp2px(context,spSize);
            paintOuterText.setTextSize(textSize);
            paintCenterText.setTextSize(textSize);
        }
    }
