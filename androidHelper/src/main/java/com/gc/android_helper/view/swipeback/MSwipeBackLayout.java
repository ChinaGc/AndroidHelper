...
public class MSwipeBackLayout extends FrameLayout {
    /**
    ...
    public MSwipeBackLayout(Context context) {
        this(context, null);
    }

    public MSwipeBackLayout(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.SwipeBackLayoutStyle);
    }

    public MSwipeBackLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs);
    ...
    public void attachToActivity(MSwipeBackActivity activity) {
        mActivity = activity;
