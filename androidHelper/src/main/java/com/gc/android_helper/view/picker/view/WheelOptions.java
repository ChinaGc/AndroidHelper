package com.gc.android_helper.view.picker.view;

import android.graphics.Typeface;
import android.view.View;

import com.gc.android_helper.view.picker.adapter.ArrayWheelAdapter;
import com.gc.android_helper.view.picker.lib.WheelView;
import com.gc.android_helper.view.picker.listener.OnItemSelectedListener;
...
public class WheelOptions<T> {
    ...
    public void setTextContentSizePx(int textPxSize) {
        wv_option1.setTextSizePx(textPxSize);
        wv_option2.setTextSizePx(textPxSize);
        wv_option3.setTextSizePx(textPxSize);
    }
    public void setTextContentSizeSp(int textPxSize) {
        wv_option1.setTextSizeSp(textPxSize);
        wv_option2.setTextSizeSp(textPxSize);
        wv_option3.setTextSizeSp(textPxSize);
    }
