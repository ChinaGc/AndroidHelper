...
public class Picker<T> implements View.OnClickListener,PopupWindow.OnDismissListener{
    ...
    public void picker(PickerParams pickerParams){
        ...
        //设置文字大小
        btnSubmit.setTextSize(TypedValue.COMPLEX_UNIT_PX,
                pickerParams.getSize_Submit_Cancel()==0?activity.getResources().getDimensionPixelSize(R.dimen.font_normal):pickerParams.getSize_Submit_Cancel());
        btnCancel.setTextSize(TypedValue.COMPLEX_UNIT_PX,
                pickerParams.getSize_Submit_Cancel()==0?activity.getResources().getDimensionPixelSize(R.dimen.font_normal):pickerParams.getSize_Submit_Cancel());

        tvTitle.setTextSize(TypedValue.COMPLEX_UNIT_PX,
                pickerParams.getSize_Title()==0?activity.getResources().getDimensionPixelSize(R.dimen.font_large):pickerParams.getSize_Title());
