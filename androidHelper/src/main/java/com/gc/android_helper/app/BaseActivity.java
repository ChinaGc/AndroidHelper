...
public abstract class BaseActivity extends MSwipeBackActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(requestPermission.size()>0) {
            ActivityCompat.requestPermissions(this, requestPermission.toArray(new String[requestPermission.size()]),
                    Permissions.CODE_FOR_ALLPERMISSION);
        }
     ...
     * @param grantResults
     */
    private ConfirmDialogParams confirmDialogParams = new ConfirmDialogParams();
    @Override
        ...
        /*switch (requestCode){//请求开启相机
            case Permissions.CAMERA:
                if(grantResults[0]!= PackageManager.PERMISSION_GRANTED){//用户不同意
                    ...
                    confirmDialogParams.setRightOnClickListener(new View.OnClickListener() {
                        @Override
                    ...
                    api.comfirm(this,confirmDialogParams);
                }
                break;
        }*/
